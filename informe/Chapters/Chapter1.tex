...
The \LaTeX{} package is available for many systems including Windows, Linux and Mac OS X. The package for OS X is called MacTeX and it contains all the applications you need  bundled together and pre-customised  for a fully working \LaTeX{} environment and workow.
...
What needs to be done is to change the paper size in the conguration file for \texttt{pdfTeX} to reflect the letter size. There is an excellent tutorial on how to do this here: \\
